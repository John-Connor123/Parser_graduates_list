...
but_path = tk.Button(start_window, text = "Запустить", font = ("Times",20),  background = "white", command = get_data_from_path)
...
def new_window():
    ...
    but_get_snils = tk.Button(left, text = "Статистика баллов ЕГЭ", font = ("Times",14),  background = "white", command = get_snils)
    but_get_snils.pack(side = "top")
    
    but_places = tk.Button(left, text = "Места в образовательных программах", font = ("Times",14),  background = "white", command = places)
    but_places.pack(side = "top")
        
    but_entrant_data = tk.Button(left, text = "Данные абитуриентов", font = ("Times",14),  background = "white", command = Entrant_data)
    ...
    but_right = tk.Button(left, text = "Сравнение с правом без экзаменов", font = ("Times",14),  background = "white", command = without_exams)
...
def get_snils():
    ...
    start = tk.Button(left, text = "запустить", font = ("Times",10),  background = "white", command = get_snils_create_table)
    start.pack(side = "top")
...
def places():
    ...
    menu_ed_program.add_command(label = 'Программа двух дипломов НИУ ВШЭ и Университета Кёнхи Экономика ', command = ep6)
    ...
    menu_ed_program.add_command(label = 'Программа двух дипломов НИУ ВШЭ и Лондонского университета по ме', command = ep34)
    ...
    menu_ed_program.add_command(label = 'Программа двух дипломов НИУ ВШЭ и Лондонского университета Прик', command = ep39)
    ...
    menu_ed_program.add_command(label = 'Цифровые инновации в управлении предприятием (программа двух дип', command = ep45)
...
def Entrant_data():
    ...
    start = tk.Button(left, text = "запустить", font = ("Times",10),  background = "white", command = entrant_data_create_table)
    start.pack(side = "top")
    ...
    save_button = tk.Button(left, text = "сохранить", font = ("Times",10),  background = "white", command = save_Entrant_data)
    save_button.pack(side = "top")
...
def without_exams():
    ...
    save_button = tk.Button(left, text = "сохранить", font = ("Times",10),  background = "white", command = save_without_exam)
    save_button.pack(side = "top")
