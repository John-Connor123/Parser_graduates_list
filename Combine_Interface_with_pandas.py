...
def run_app():
    ...
    def get_snils():
        ...
        def day_theme():
            ...
            big.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            little.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            equally.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            ...
            create_graph.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
    ...
    def places():
        ...
        def day_theme():
            ...
            left.config(bg="#f0f0f0")
            name.config(bg="white", fg="#000000")
            paid.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            budget.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            clear.config(bg="white", fg="#000000")
            start.config(bg="white", fg="#000000")
            path_xlsx.config(bg="white", fg="#000000")
            name_xlsx.config(bg="white", fg="#000000")
    ...
    def Entrant_data():
        ...
        def day_theme():
            window.config(bg="#f0f0f0")
            left.config(bg="#f0f0f0")
            right.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            no_right.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            special.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            no_special.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
            target.config(bg="#f0f0f0", fg="#000000", selectcolor="white")
